...
class ImitationLearning(Agent):
    ...
    def __init__(self, city_name, avoid_stopping, memory_fraction=0.25, image_cut=[115, 510]):
        ...
        self._models_path ="/home/pankaj/CARLA_0.8.4/trainer11/CARLAILtrainer/models/"#"D:/outbox/changed_old_trainer/trainer5/models/"#dir_path + '/model/'
    ...
    def _compute_action(self, rgb_image, speed, direction=None):
        ...
        self.command_follower.params['target_speed'] = 30.0 # Fixed speed limit to 30 km/hr for testing 
        if acc > brake:
            brake = 0.0
